...
import { BloodTestIcon, GeneralCheckupIcon, MammogramIcon } from "../components/icons/HeathIcons";
import { FooterBar } from "../components/footerBar";
import { Exame } from "../interfaces/IExame";
            ...
            <Grid item xs={12} sm={6} md={4} key={exam.cartaoSus}>
              <Card className="rounded-lg shadow-md">
                <CardHeader
                  ...
                  className={`bg-mediumPink text-white`} // Cor fixa ou defina uma lógica
                />
                <CardActionArea>
